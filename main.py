...
horizontal_exp_lines(ax, stats1['mean'], humidity, x_intersect1)
horizontal_exp_lines(ax, stats2['mean'], humidity2, x_intersect2)
vertical_exp_line(ax, x_intersect1, humidity, stats1['mean'])
vertical_exp_line(ax, x_intersect2, humidity2, stats2['mean'])
